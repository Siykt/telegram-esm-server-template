...
declare module 'node-telegram-bot-api' {
  ...
  declare namespace TelegramBot {
    ...
    interface TelegramEvents {
      message: (message: Message, metadata: Metadata) => ExpectedAnyData
      text: (message: Message, metadata: Metadata) => ExpectedAnyData
      animation: (message: Message, metadata: Metadata) => ExpectedAnyData
      audio: (message: Message, metadata: Metadata) => ExpectedAnyData
      channel_chat_created: (message: Message, metadata: Metadata) => ExpectedAnyData
      contact: (message: Message, metadata: Metadata) => ExpectedAnyData
      delete_chat_photo: (message: Message, metadata: Metadata) => ExpectedAnyData
      document: (message: Message, metadata: Metadata) => ExpectedAnyData
      game: (message: Message, metadata: Metadata) => ExpectedAnyData
      group_chat_created: (message: Message, metadata: Metadata) => ExpectedAnyData
      invoice: (message: Message, metadata: Metadata) => ExpectedAnyData
      left_chat_member: (message: Message, metadata: Metadata) => ExpectedAnyData
      location: (message: Message, metadata: Metadata) => ExpectedAnyData
      migrate_from_chat_id: (message: Message, metadata: Metadata) => ExpectedAnyData
      migrate_to_chat_id: (message: Message, metadata: Metadata) => ExpectedAnyData
      new_chat_members: (message: Message, metadata: Metadata) => ExpectedAnyData
      new_chat_photo: (message: Message, metadata: Metadata) => ExpectedAnyData
      new_chat_title: (message: Message, metadata: Metadata) => ExpectedAnyData
      passport_data: (message: Message, metadata: Metadata) => ExpectedAnyData
      photo: (message: Message, metadata: Metadata) => ExpectedAnyData
      pinned_message: (message: Message, metadata: Metadata) => ExpectedAnyData
      sticker: (message: Message, metadata: Metadata) => ExpectedAnyData
      successful_payment: (message: Message, metadata: Metadata) => ExpectedAnyData
      supergroup_chat_created: (message: Message, metadata: Metadata) => ExpectedAnyData
      video: (message: Message, metadata: Metadata) => ExpectedAnyData
      video_note: (message: Message, metadata: Metadata) => ExpectedAnyData
      voice: (message: Message, metadata: Metadata) => ExpectedAnyData
      video_chat_started: (message: Message, metadata: Metadata) => ExpectedAnyData
      video_chat_ended: (message: Message, metadata: Metadata) => ExpectedAnyData
      video_chat_participants_invited: (message: Message, metadata: Metadata) => ExpectedAnyData
      video_chat_scheduled: (message: Message, metadata: Metadata) => ExpectedAnyData
      message_auto_delete_timer_changed: (message: Message, metadata: Metadata) => ExpectedAnyData
      chat_invite_link: (message: Message, metadata: Metadata) => ExpectedAnyData
      chat_member_updated: (message: Message, metadata: Metadata) => ExpectedAnyData
      web_app_data: (message: Message, metadata: Metadata) => ExpectedAnyData
      callback_query: (query: CallbackQuery) => ExpectedAnyData
      inline_query: (query: InlineQuery) => ExpectedAnyData
      poll: (pollObject: Poll) => ExpectedAnyData
      poll_answer: (poll: PollAnswer) => ExpectedAnyData
      chat_member: (member: ChatMemberUpdated) => ExpectedAnyData
      my_chat_member: (member: ChatMemberUpdated) => ExpectedAnyData
      chosen_inline_result: (result: ChosenInlineResult) => ExpectedAnyData
      channel_post: (message: Message) => ExpectedAnyData
      edited_message: (message: Message) => ExpectedAnyData
      edited_message_text: (message: Message) => ExpectedAnyData
      edited_message_caption: (message: Message) => ExpectedAnyData
      edited_channel_post: (message: Message) => ExpectedAnyData
      edited_channel_post_text: (message: Message) => ExpectedAnyData
      edited_channel_post_caption: (message: Message) => ExpectedAnyData
      shipping_query: (query: ShippingQuery) => ExpectedAnyData
      pre_checkout_query: (query: PreCheckoutQuery) => ExpectedAnyData
      polling_error: (error: Error) => ExpectedAnyData
      webhook_error: (error: Error) => ExpectedAnyData
      chat_join_request: (query: ChatJoinRequest) => ExpectedAnyData
    }
  }

  declare class TelegramBotEventEmitter<E extends Record<string, ExpectedAnyData>> {
    ...
    on<K extends string | symbol>(
      ...
      listener: (...args: ExpectedAnyData[]) => ExpectedAnyData
    ...
    emit<K extends string | symbol>(event: Exclude<K, keyof E>, ...args: ExpectedAnyData[]): boolean
  }

  declare class TelegramBot extends TelegramBotEventEmitter<TelegramBot.TelegramEvents> {
    constructor(token: string, options?: TelegramBot.ConstructorOptions)

    startPolling(options?: TelegramBot.StartPollingOptions): Promise<ExpectedAnyData>

    stopPolling(options?: TelegramBot.StopPollingOptions): Promise<ExpectedAnyData>

    isPolling(): boolean

    openWebHook(): Promise<ExpectedAnyData>

    closeWebHook(): Promise<ExpectedAnyData>
    ...
    getStickerSet(name: string, options?: ExpectedAnyData): Promise<TelegramBot.StickerSet>

    getCustomEmojiStickers(customEmojiIds: string[], options?: ExpectedAnyData): Promise<TelegramBot.Sticker[]>

    uploadStickerFile(
      userId: number,
      pngSticker: string | Stream | Buffer,
      options?: ExpectedAnyData,
      fileOptions?: TelegramBot.FileOptions
    ...
    deleteStickerFromSet(sticker: string, options?: ExpectedAnyData): Promise<boolean>
    ...
    deleteMessage(chatId: TelegramBot.ChatId, messageId: number, options?: ExpectedAnyData): Promise<boolean>
    ...
    ): Array<(data: ExpectedAnyData, metadata?: TelegramBot.Metadata) => void>
    ...
    createInvoiceLink(
      ...
      providerToken: string,
      currency: string,
      prices: TelegramBot.Price[],
      options?: TelegramBot.InlineQuery
    ): Promise<string>
  }
